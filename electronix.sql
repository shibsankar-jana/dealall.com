...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2016 at 06:03 AM
...
CREATE TABLE `sess_cart` (
  `sess_cart_id` int(11) NOT NULL,
  `u_id` int(11) NOT NULL,
  `p_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sess_cart`
--

INSERT INTO `sess_cart` (`sess_cart_id`, `u_id`, `p_id`) VALUES
(1, 1, 29),
(19, 61, 29),
(20, 61, 35);
...
INSERT INTO `user` (`id`, `name`, `email`, `phone`, `username`, `password`, `address`, `pin_code`) VALUES
(37, 'santukhamari', 'santukhamari@gmail.com', '7278833968', 'admin', 'admin', '', ''),
(38, 'shibu', 'sourav.rb@gmail.com', '7278833965', 'santu', '123456', '', ''),
(39, 'shibsankar jana ', 'shibsankar@expressgrp.com', '9593624508', 'shibsankar', '1fb0e157ee59c3a67a71691f5090a4af', '', ''),
(40, 'shibu', 'shibsankar.j@gmail.com', '959362701', 'shibu', '4f4b3d5a704d603ca88b2aaac3a3d73f', '', ''),
(48, 'fdgdf', 'fdh@gmail.com', '97000000', 'qqqq', '3bad6af0fa4b8b330d162e19938ee981', 'rfeyhgndfh ydnjyt', 'rfeyhgndfh ydnjyt'),
(65, 'lalu', 'lalu@gmail.com', '8798435435', 'lallu', '0aa8c88657c1942600e1dd57791c9829', 'dcqecwqe', '46512'),
(63, 'shibu', 'shibu@gmail.com', '1234567890', 'shibu', '4f4b3d5a704d603ca88b2aaac3a3d73f', 'sadd', '45'),
(64, 'shibu', 'shibu@gmail.com', '1234567890', 'shibu', '4f4b3d5a704d603ca88b2aaac3a3d73f', 'sadd', '45'),
(62, 'shibu', 'shibu@gmail.com', '9593624508', 'shibu', '4f4b3d5a704d603ca88b2aaac3a3d73f', 'kolkata', '700059'),
(59, 'aaaaa', 'aaaa@gmail.com', '987654235', 'aaaaa', '594f803b380a41396ed63dca39503542', 'aaaaa', '456123'),
(60, 'aaaaa', 'aaaa@gmail.com', '987654235', 'aaaaa', '594f803b380a41396ed63dca39503542', 'aaaaa', '456123'),
(61, 'shankar jana', 'shibsankar@gmail.com', '9593624508', 'shankar', 'e36746428c0084e5444890f46c97b6b8', 'assasda', '465132');
...
--
-- Indexes for table `add_to_product`
--
ALTER TABLE `add_to_product`
...
--
-- Indexes for table `sess_cart`
--
ALTER TABLE `sess_cart`
  ADD PRIMARY KEY (`sess_cart_id`);
...
--
-- Indexes for table `tabletes&ipads`
--
ALTER TABLE `tabletes&ipads`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `add_to_product`
--
ALTER TABLE `add_to_product`
  MODIFY `kart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
ALTER TABLE `sales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `sess_cart`
--
ALTER TABLE `sess_cart`
  MODIFY `sess_cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
-- AUTO_INCREMENT for table `tabletes&ipads`
--
ALTER TABLE `tabletes&ipads`
